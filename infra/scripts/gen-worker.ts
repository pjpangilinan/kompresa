...
const WORKER_DIR = join(import.meta.dirname, '..', 'worker');
mkdirSync(WORKER_DIR, { recursive: true });

writeFileSync(
  join(WORKER_DIR, 'Dockerfile'),
...
console.log('Wrote worker scaffold to', WORKER_DIR);
